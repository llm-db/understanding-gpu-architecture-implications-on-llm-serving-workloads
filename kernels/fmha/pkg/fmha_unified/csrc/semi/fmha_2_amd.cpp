        ...
        for (int j = 0; j < j_max; j++) {
            ...
            for (int k = 0; k < (d / 16); k++) {
                ...
                for (int m = 0; m < 2; m++) {
                    ...
                    load_matrix_sync(A_frag[m], q_smem[frag_q_smem_x], 16);
                    
                }
                #pragma unroll
                for (int n = 0; n < 2; n++) {        
                    const int frag_k_smem_x = k_smem_x + 16 * n;
                    load_matrix_sync(B_frag[n], k_smem[frag_k_smem_x], 16);
                }
                #pragma unroll
                for (int m = 0; m < 2; m++) {
                    #pragma unroll
...

            {
                ...
                for (int m = 0; m < 2; m++) {
                    ...
                    for (int n = 0; n < 2; n++) {
                        ...
                        store_matrix_sync(&s_p_smem[s_p_smem_x][s_p_smem_y], C_frag[m][n], 64, mem_row_major);
                    }
                }
            }
